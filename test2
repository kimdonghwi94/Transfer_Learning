...
base_dir = 'C:/Users/우쓰/PycharmProjects/untitled/data/batch2'
bas='C:/Users/우쓰/PycharmProjects/untitled/data/batch2/test_mini'
...
model.compile(optimizer=optimizers.Adam(0.001),
                ...
                metrics=['acc'])
history = model.fit(train_features, train_labels,batch_size=batch_size,epochs=epochs,callbacks=[tb])
...
def visualize_predictions(classifier, n_cases):
    ...
    for i in range(0,n_cases):
        ...
        if prediction==0 and img_path[60] == 'N':
            a.append(1)
        elif prediction==1 and img_path[60] == 'M':
            b.append(1)
        elif prediction== 2 and img_path[60] == 'R':
            c.append(1)
        elif prediction == 3 and img_path[60] == 'O':
            d.append(1)
        elif prediction==0 and img_path[60] != 'N':
            a.append(0)
        elif prediction==1 and img_path[60] != 'M':
            b.append(0)
        elif prediction==2 and img_path[60] != 'R':
