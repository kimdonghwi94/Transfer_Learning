...
bas='/home/kim/PycharmProjects/tensorflow2.0-gpu/donghwikim/create/'
...
def visualize_predictions(classifier, n_cases):
    for i in range(0,n_cases):
        ...
        print(img_path)
        if prediction==0 and img_path[63] == 'N':
            a.append(1)
        elif prediction==1 and img_path[63] == 'M':
            b.append(1)
        elif prediction== 2 and img_path[63] == 'R':
            c.append(1)
        elif prediction == 3 and img_path[63] == 'O':
            d.append(1)
        elif prediction==0 and img_path[63] != 'N':
            a.append(0)
        elif prediction==1 and img_path[63] != 'M':
            b.append(0)
        elif prediction==2 and img_path[63] != 'R':
