...
def visualize_predictions(classifier, n_cases):
    for i in range(0,n_cases):
        ...
        if prediction==0 and img_path[24] == 'N':
            ...
            if img_path[24]=='M':
                cv2.imwrite('/home/kim/PycharmProjects/tensorflow2.0-gpu/donghwikim/create/DME/{}'.format(random_img),im)

            elif img_path[24]=='R':
                cv2.imwrite('/home/kim/PycharmProjects/tensorflow2.0-gpu/donghwikim/create/DRUSEN/{}'.format(random_img),im)

            elif img_path[24]=='O':
                cv2.imwrite('/home/kim/PycharmProjects/tensorflow2.0-gpu/donghwikim/create/NORMAL/{}'.format(random_img),im)
            ...
            if img_path[24]=='N':
                cv2.imwrite('/home/kim/PycharmProjects/tensorflow2.0-gpu/donghwikim/create/CNV/{}'.format(random_img),im)
    ...
    print(l)
model = keras.models.load_model('donghwikim/image_model/Inceptionresnet (1).h5')
